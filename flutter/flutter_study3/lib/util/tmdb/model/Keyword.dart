...
MovieKeywords movieKeywordsFromJson(String str) =>
    MovieKeywords.fromJson(json.decode(str));
...
class MovieKeywords {
  ...
  factory MovieKeywords.fromJson(Map<String, dynamic> json) => MovieKeywords(
        id: json["id"],
        keywords: List<TMMovieKeyword>.from(
            json["keywords"].map((x) => TMMovieKeyword.fromJson(x))),
      );
